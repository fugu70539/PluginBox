...
export const SettingsBanner = () => {
  return (
    <motion.div
      ...
      className="relative w-full h-[100px] mt-glass overflow-hidden rounded-[30px] flex items-center px-6 border-white/[0.05]"
      style={{ backgroundColor: "#7549F2" }}
    >
      {/* Анимированная иконка слева с прозрачностью */}
